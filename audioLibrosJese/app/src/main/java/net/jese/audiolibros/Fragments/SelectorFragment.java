package net.jese.audiolibros.Fragments;
...
import net.jese.audiolibros.AdaptadorLibrosFiltro;
import net.jese.audiolibros.Aplicacion;
import net.jese.audiolibros.Libro;
import net.jese.audiolibros.MainActivity;
import net.jese.audiolibros.Fragments.*;
...
public class SelectorFragment extends Fragment{
    ...
    @Override public void onAttach(Context contexto) {
        ...
        if (contexto instanceof Activity) {
            ...
            adaptador = (AdaptadorLibrosFiltro) app.getAdaptador();
