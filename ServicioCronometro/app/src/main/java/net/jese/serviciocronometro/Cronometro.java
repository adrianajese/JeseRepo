package net.jese.serviciocronometro;
...
public class Cronometro extends Service {
    ...
    public static net.jese.serviciocronometro.PoiService UPDATE_LISTENER;
     ...
     * @param poiService
     */
    public static void setUpdateListener(net.jese.serviciocronometro.PoiService poiService) {
